...
import { mockLoginCredentials } from "src/app/testing/mockData";
...
describe('AuthService', () => {
    ...
    it('should check if user has any authority', () =>{
        service.hasAnyAuthority(RolesConstants.ROLE_LANDLORD);

        expect(authStoreSpy.hasAnyAuthority).toHaveBeenCalledWith(RolesConstants.ROLE_LANDLORD);
